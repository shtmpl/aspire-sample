...
@SpringBootTest
public class ScheduledGeoposDisseminationServiceIntegrationTest {
    ...
    public void setUp() throws Exception {
        ...
        scheduledGeoposDisseminationRepository.deleteAll();
    ...
    public void shouldSaveDissemination() throws Exception {
        ...
        ScheduledGeoposDissemination dissemination = scheduledGeoposDisseminationService.saveDissemination(ScheduledGeoposDissemination.builder()
                .priority(0)
                .start(now)
                .end(now.plusDays(1))
                .cron("* * * * * ?")
        ...
        ScheduledGeoposDissemination found = scheduledGeoposDisseminationRepository.findById(dissemination.getId())
    ...
    public void shouldStartDissemination() throws Exception {
        ...
        Campaign campaign = campaignRepository.save(Campaign.builder()
                ...
                .build());
        scheduledGeoposDisseminationRepository.save(dissemination.setCampaign(campaign));


        scheduledGeoposDisseminationService.startDissemination(dissemination);
    ...
    public void shouldExecuteDissemination() throws Exception {
        ...
        scheduledGeoposDisseminationService.executeDissemination(dissemination.getId());
