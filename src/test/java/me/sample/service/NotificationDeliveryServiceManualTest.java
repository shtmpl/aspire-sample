...
public class NotificationDeliveryServiceManualTest {
    ...
    public void shouldSendNotification() throws Exception {
        ...
        notificationDeliveryService.sendNotification(notification.getId());
//        notificationDeliveryService.sendNotificationViaQueue(notification.getId());
